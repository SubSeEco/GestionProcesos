...
using App.Infrastructure.GestionProcesos;
using System;
...
namespace App.Infrastructure.Persona
{
    public class Persona : IPersona
    {
        private readonly AppContextPersona _context;

        public Persona(AppContextPersona contextPersona)
        {
            _context = contextPersona;
