...
namespace App.Core.Interfaces
{
    public interface IEmail 
    {
        ...
        void NotificacionesCometido(Model.Core.Workflow workflow, Model.Core.Configuracion plantillaCorreo, string asunto, List<string> Mails, int IdCometido, string FechaSolicitud, string Observaciones);
        void Send();
    }
}