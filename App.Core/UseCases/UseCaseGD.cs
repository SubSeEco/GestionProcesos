...
namespace App.Core.UseCases
{
    public class UseCaseGD
    {
        ...
        public ResponseMessage UpdatePlazo(GD obj)
        {
            var response = new ResponseMessage();
            try
            {
        ...
        public ResponseMessage UpdatePlazoProceso(GD obj, GD model)
        {
            var response = new ResponseMessage();
            try
            {
                model.FechaPlazo = obj.FechaPlazo;
                model.PlazoEstablecido = true;
