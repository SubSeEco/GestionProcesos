...
namespace App.Core.UseCases
{
    public class UseCaseCuentaRed
    {
        ...
        public UseCaseCuentaRed(IGestionProcesos repositoryGestionProcesos, IHSM hsm)
        {
            _repository = repositoryGestionProcesos;
            _hsm = hsm;
        }

        public ResponseMessage CuentaRedInsert(CuentaRed obj)
        {
        ...
        public ResponseMessage CuentaRedUpdate(CuentaRed obj)
        {
            var response = new ResponseMessage();
