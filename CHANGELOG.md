...
## [2.7.1 - Cometidos - GP] - 30-08-2023

### Added

- Se agrega FechaFirma a Documento.

### Changed

- Se modifica Documento para agregar FechaFirma, TipoDocumentoFirma, FirmanteEmail y FirmanteUnidad como string y no codigo
...
## [2.6.2.9 - Cometidos - 20-06-2023]

### Changed

- Se modifico el tamaño de pagina para la generacion de las resoluciones de cometidos.

## [2.6.2.9 - Cometidos - 19-06-2023]

### Changed

- Se descomentaron las localidades de las comunas de Paredones, Navidad y Marchihue.

## [2.6.2.9 - Cometidos - 16-06-2023]

### Changed

- Se cambio el formato de las resoluciones segun lo indicado por GGPP y Procesos.
- Se modifico validacion de 20 dias al momento de guardar el proceso en la tarea de Aprobacion GGPP.

### Added

- Se agrego, de forma manual, margenes para las resoluciones de Ministro y Contrata.

## [2.6.2.8 - Cometidos - 12-06-2023]

### Changed

- Se modificaron las vistas donde se indicaba el mensaje de tramitación de 20 dias a 7 dias.
- Se modificaron los parrafos en resoluciones, indicando que es del instructivo de "GAB. PRES N°001 de 18 de abril de 2023".
